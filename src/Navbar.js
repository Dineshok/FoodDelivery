...
function Navbar() {
  ...
  function showTheCart() {
    // Using an absolute path ensures that the route becomes "/FoodDelivery/shopingCart"
    navigate("/shopingCart");
  }

  const currentCart = useSelector((state) => state.foodReducer.foodData);
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ...
                      : "rounded-md px-3 py-2 text-lg font-medium text-white hover:bg-gray-700"
                  }
                >
                  Home
                </NavLink>
